...
O.make_orbit_map('/path/to/outfile.dat','/path/to/exp/files',tarr,comp='dark')

times,mass,orb = O.read_orbit_map('/path/to/outfile.dat')
...
class TrackOrbits(object):
    ...
    def make_orbit_map(self,outfile,infile_template,time_array,norb=1,comp='star',verbose=0,**kwargs):
